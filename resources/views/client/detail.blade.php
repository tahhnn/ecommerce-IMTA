...
<div class="container mx-auto">
    ...
    <div class="container px-5 py-24 mx-auto">
      <div class="lg:w-4/5 mx-auto flex flex-wrap">
        <img class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="{{ asset('image/' . $data->img) }}"  alt="ecommerce">
        {{-- <img  class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="	https://images.unsplash.com/photo-1508423134147-ad…WQiOjEyMDd9&auto=format&fit=crop&w=400&h=400&q=80"> --}}
...
@csrf
<button class="flex ml-auto  bg-black border-1 py-2 px-6 text-white focus:outline-none hover:bg-red-300 transition duration-500 rounded"><span class="">Thêm vào giỏ hàng</span></button>
